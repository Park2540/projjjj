      ...
      <div>
        ...
        <Grid style={{ backgroundColor: grey }}>
          <GridCell style={{ padding: '2em', textAlign: 'center' }}>
            <H3 font="secondary">สินค้า</H3>

            <p style={{ marginTop: '1em', color: grey2 }}> รายการสินค้าผมไม่สามารถทำได้ครับจารขอความกรุณาด้วยครับ </p>
          </GridCell>
        </Grid>
        ...
        <Grid style={{ backgroundColor: grey }}>
          <GridCell style={{ padding: '3em', textAlign: 'center' }}>
            <p style={{ marginBottom: '1em', color: grey2 }}>MY APOLOGIES. T_T</p>
